  ...
  return (
    <div id="who-outer">
      <div id="who">
        ...
        <p>
          I’m here to help you feel more confident, clear-minded, and in control
          of your life.
        </p>
        <p>
          ...
          and a deep passion for helping others, I guide my clients through the
          mental and emotional blocks that hold them back — whether it’s stress,
          self-doubt, unhealthy habits, or simply feeling stuck.
        </p>
        <p>
        ...
        <p>
          👉 Let’s chat! [Book your free call] and see how I can support you.
        </p>
      </div>
    </div>
  );
